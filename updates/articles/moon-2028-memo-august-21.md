...
The memorandum does not say that. Its text sets no date for a crewed lunar landing, and it does not mention 2028 anywhere. What it contains instead is a target for how often the country can fly at all: "By 2030, our space transportation ranges must grow to support more than 1,000 launches and reentries every year."

That 2028 goal is real, though it was signed eight months earlier. Executive Order 14369, "Ensuring American Space Superiority," dated December 18, 2025, called for astronauts on the moon by 2028 and the first elements of a lunar outpost by 2030. The distinction is worth drawing because of what has happened to NASA's own schedule since that order was signed. The agency's plan no longer puts a landing on Artemis 3 at all.
...
Most of its substance is deadlines assigned to named officials. The Secretary of the Interior has 90 days to identify federal land that could host a reentry site. The Departments of State and Commerce have 120 days to update export policies. Within 180 days, the Secretary of War and the NASA administrator are to develop scheduling criteria for federal ranges, and the Secretary of Transportation is to identify locations for additional launch facilities.
...
That decision moved the first crewed landing since 1972 to Artemis 4, which NASA is targeting for 2028. The 2028 goal in December's executive order now rests entirely on a mission one flight further out than the one originally meant to carry it.
...
Artemis is unusually exposed to that number. As restructured, Artemis 3 needs three launches on three different rockets, with Orion meeting a Blue Moon test article and a Starship in low Earth orbit. The landing on Artemis 4 depends on Starship's Human Landing System (HLS), which cannot reach the moon on a single launch. It has to be fueled in orbit by a series of tanker flights, and how many is contested: the Government Accountability Office (GAO) has put it at 16 launches for one mission, while a SpaceX vice president said in 2024 that the number would be "10-ish."

![Artist's rendering of SpaceX's Human Landing System on the lunar surface. Reaching this point requires an orbital refueling campaign that the Government Accountability Office estimates at 16 launches. Credit: SpaceX/NASA.](https://grandmasterjc.github.io/artemis2-config/updates/images/starship_hls_earthrise.jpg)
...
Starship Flight 14, expected late this month, is the nearest hard test, since it would be the vehicle's first attempt to reach orbit and its first attempt at catching the ship with the launch tower. Watch also for NASA to attach an actual month to Artemis 3 rather than "next year," and for the agency to describe what it means by the lunar logistics architecture that Section 6(c) now requires of it.

What Trump signed on Thursday is a transportation policy, with real deadlines attached to real officials, and it addresses a genuine constraint on getting to the moon. It set no landing date, and nobody ordered a moon landing this week.

The date itself lives in an executive order from last December, and it survived a February decision that moved the landing off Artemis 3 and onto Artemis 4. Whether anyone stands on the moon in 2028 now depends on that later mission holding a schedule the earlier one could not.

If you want to follow the flights that will decide whether 2028 holds as they happen, that is what our companion app Liftoff is built for. Live countdowns, real-time status and one-tap access to the official webcasts for every launch worldwide, free on the App Store: [Liftoff — Rocket & Space Launch](https://apps.apple.com/no/app/liftoff-rocket-space-launch/id6776392285).
