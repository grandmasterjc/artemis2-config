---
id: lunar-debris-spacex-impact-august-26
title: "A SpaceX rocket hit the moon this month, and no rule required a safer disposal"
subtitle: "NASA confirmed the crater on August 18: an 18-meter pit near Einstein Crater, made by a Falcon 9 upper stage abandoned in orbit 19 months earlier. It is the third known accident of its kind, and with more than 100 lunar missions already booked for the next decade, the numbers say it will not be the last."
date: 2026-08-26
mission: artemis3
premium: false
hero_image: hero.jpg
push_title: "A SpaceX rocket just hit the moon"
push_body: "NASA confirmed the crater on August 18. It's the third known accident like it, and more than 100 lunar missions are already booked."
---
...
SpaceX's own account of its practices makes the same point from the other direction. For most missions, the company said in a statement, it carries out a controlled deorbit of the Falcon 9 second stage back into Earth's atmosphere. "For high-energy missions like those to a lunar transfer orbit, nearly all performance on the vehicle is devoted to successfully placing the payload in the intended orbit, and a controlled disposal maneuver is not always possible," the statement continued. Some countries apply their own rules to hardware they launch, but nothing universal covers a stage once it is bound for the moon.

## More hardware headed for the same patch of ground

NASA's own manifest is a large part of why that gap matters now. On June 30, the agency awarded nearly $600 million for four more Commercial Lunar Payload Services (CLPS) deliveries, split between Astrobotic, Firefly Aerospace and Intuitive Machines, adding to the same pipeline that produced the stage that just hit the moon. China added to the pressure on August 24, launching Chang'e-7, an orbiter, lander, rover and hopping probe aimed at the illuminated rim of Shackleton crater to search for water ice.

That landing target is not just any point on the map. Peak Near Shackleton is second on NASA's own list of 13 candidate regions for a future crewed Artemis landing, published in 2022. Two countries' hardware is now converging on the same patch of terrain at the lunar south pole, and neither is obligated to leave it any cleaner than it was found.

## Three tests still ahead this year

Starship Flight 14, tentatively no earlier than August 28 after slipping once already from Elon Musk's original end-of-month target, would be the vehicle's first attempt at reaching orbit. Blue Origin still says it intends to return New Glenn to flight before the end of 2026, carrying a Blue Moon Mark 1 test lander once it does. Chang'e-7's lander is not expected to attempt its touchdown near Shackleton for months yet, giving NASA's own south-pole planning a preview of the neighborhood first. None of those three milestones changes the rule that currently governs a lunar-transfer stage's disposal, because there isn't one to change.

NASA's August 18 images gave the clearest picture yet of what a rocket looks like after it hits the moon by accident: a small bright scar, tracked by astronomers on three continents and confirmed from a telescope in Chile and an orbiter above the moon before NASA's own camera arrived overhead. That is a tidy, well-documented outcome, and also the limit of what got resolved. Nobody had to sign off on where that stage came down, and under the rules that exist today, nobody has to sign off on the next one either.

If you want to follow the growing list of lunar missions adding to that tally as they fly, that is what our companion app Liftoff is built for. Live countdowns, real-time status and one-tap access to the official webcasts for every launch worldwide, free on the App Store: [Liftoff — Rocket & Space Launch](https://apps.apple.com/no/app/liftoff-rocket-space-launch/id6776392285).
